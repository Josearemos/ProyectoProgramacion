...
public class dragonquest extends JFrame {
	...
	public dragonquest() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new vista.facturadragonquest().setVisible(true);
                dispose();
			}
		});
		...
		dtrpnKratosHaDejado.setText("El \u00FAltimo juego de rol de la ic\u00F3nica franquicia DRAGON QUEST ofrece \r\ncombates muy equilibrados por turnos y una amplia variedad de \r\nactividades mientras exploras un vasto y maravilloso mundo.\r\n\r\nSigue la historia del Luminario, al que tildan de \"Engendro Oscuro\", y re\u00FAne \r\na un elenco de compa\u00F1eros leales y carism\u00E1ticos, cuyo aspecto \r\nest\u00E1 inspirado en los dise\u00F1os del famoso dibujante Akira Toriyama.");
		dtrpnKratosHaDejado.setBounds(153, 229, 494, 132);
